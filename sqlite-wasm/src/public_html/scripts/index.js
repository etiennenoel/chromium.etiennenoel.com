var SqliteClientTypeEnum;
(function (SqliteClientTypeEnum) {
    SqliteClientTypeEnum["MemoryMainThread"] = "MEMORY_MAIN_THREAD";
    SqliteClientTypeEnum["MemoryWorker"] = "MEMORY_WORKER";
    SqliteClientTypeEnum["OpfsWorker"] = "OPFS_WORKER";
    SqliteClientTypeEnum["OpfsSahWorker"] = "OPFS_SYNC_ACCESS_HANDLE_WORKER";
})(SqliteClientTypeEnum || (SqliteClientTypeEnum = {}));/*
...
(function (ReturnValueEnum) {
    ReturnValueEnum["This"] = "this";
    ReturnValueEnum["ResultRows"] = "resultRows";
    ReturnValueEnum["SaveSql"] = "saveSql";
})(ReturnValueEnum || (ReturnValueEnum = {}));var RowModeEnum;
(function (RowModeEnum) {
    RowModeEnum["Array"] = "array";
    RowModeEnum["Object"] = "object";
...
class InMainThreadSqliteAdapter {
    constructor(options) {
...
})(SqliteMessageTypeEnum || (SqliteMessageTypeEnum = {}));class CreateDatabaseMessage {
    constructor(options) {
        this.options = options;
        this.type = SqliteMessageTypeEnum.CreateDatabase;
        this.uniqueId = crypto.randomUUID();
    }
}class ExecuteSqlMessage {
...
const bootstrap = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield webSqlite.init();
    yield webSqlite.executeSql("CREATE TABLE IF NOT EXISTS test(a,b)");
    yield webSqlite.executeSql("INSERT INTO test VALUES(?, ?)", [6, 7]);
    const results = yield webSqlite.executeSql("SELECT * FROM test");
