...
})(SqliteMessageTypeEnum || (SqliteMessageTypeEnum = {}));class CreateDatabaseResultMessage {
    constructor(uniqueId) {
        this.uniqueId = uniqueId;
        this.type = SqliteMessageTypeEnum.CreateDatabaseResult;
    }
}/*
...
self.sqlite3ApiBootstrap.initializers.push(function(sqlite3){
  sqlite3.version = {"libVersion": "3.41.2", "libVersionNumber": 3041002, "sourceId": "2023-03-22 11:56:21 0d1fc92f94cb6b76bffe3ec34d69cffde2924203304e8ffc4155597af0c191da","downloadVersion": 3410200};
});
...
})();class ExecuteSqlResultMessage {
    constructor(uniqueId, result) {
        this.uniqueId = uniqueId;
        this.result = result;
        this.type = SqliteMessageTypeEnum.ExecuteSqlResult;
    }
}let db;
    ...
    switch (sqliteMessage.type) {
        case SqliteMessageTypeEnum.CreateDatabase:
            toExportForESM({
                ...
                try {
                    db = new sqlite3.oo1.OpfsDb(sqliteMessage.filename);
                    self.postMessage(new CreateDatabaseResultMessage(sqliteMessage.uniqueId));
                }
                catch (err) {
